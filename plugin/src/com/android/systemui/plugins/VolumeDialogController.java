...
public interface VolumeDialogController {
    ...
    final class State {
        ...
        public String toString(int indent) {
            ...
            sep(sb, indent);
            sb.append("disallowAlarms:").append(disallowAlarms);
            sep(sb, indent);
            sb.append("disallowMedia:").append(disallowMedia);
            sep(sb, indent);
            sb.append("disallowSystem:").append(disallowSystem);
            sep(sb, indent);
            sb.append("disallowRinger:").append(disallowRinger);
            if (indent > 0) sep(sb, indent);
