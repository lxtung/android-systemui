...
class QSPanelControllerTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var qsTileRevealControllerFactory: QSTileRevealController.Factory
    @Mock
    ...
    @Mock
    private lateinit var brightnessControllerFactory: BrightnessController.Factory
    @Mock
    private lateinit var brightnessController: BrightnessController
    @Mock
    private lateinit var brightnessSlider: BrightnessSliderController
    @Mock
    private lateinit var brightnessSliderFactory: BrightnessSliderController.Factory
    @Mock
    ...
    @Mock
    private lateinit var otherTile: QSTile
    @Mock
