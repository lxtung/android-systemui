...
public class NotificationSectionsManagerTest extends SysuiTestCase {
    ...
    @Mock
    private NotificationStackScrollLayout mNssl;
    @Mock
    ...
    @Mock
    private NotificationSectionsFeatureManager mSectionsFeatureManager;
    @Mock
    ...
    @Mock
    private NotificationSectionsLogger mLogger;
    @Mock
    private MediaContainerController mMediaContainerController;
    @Mock
    private SectionHeaderController mIncomingHeaderController;
    @Mock
    private SectionHeaderController mPeopleHeaderController;
    @Mock
    private SectionHeaderController mAlertingHeaderController;
    @Mock
    private SectionHeaderController mSilentHeaderController;
    @Mock
