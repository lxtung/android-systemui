...
public class NotificationStackScrollLayoutTest extends SysuiTestCase {
    ...
    @Mock
    private SysuiStatusBarStateController mBarState;
    @Mock
    private NotificationGroupManagerLegacy mGroupMembershipManger;
    @Mock
    ...
    @Mock
    private NotificationStackScrollLayoutController mStackScrollLayoutController;
    @Mock
