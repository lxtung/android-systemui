...
class ShadeEventCoordinatorTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var logger: ShadeEventCoordinatorLogger
    @Mock
    private lateinit var executor: Executor
    @Mock
    private lateinit var notifRemovedByUserCallback: Runnable
    @Mock
    private lateinit var shadeEmptiedCallback: Runnable
