...
public class HideNotifsForOtherUsersCoordinatorTest extends SysuiTestCase {
    ...
    @Mock
    private PluggableListener<NotifFilter> mInvalidationListener;
    @Mock
    private SharedCoordinatorLogger mLogger;

    @Captor
    private ArgumentCaptor<UserChangedListener> mUserChangedListenerCaptor;
    @Captor
    private ArgumentCaptor<NotifFilter> mNotifFilterCaptor;
