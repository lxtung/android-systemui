...
public class PreparationCoordinatorTest extends SysuiTestCase {
    ...
    @Captor
    private ArgumentCaptor<NotifCollectionListener> mCollectionListenerCaptor;
    @Captor
    private ArgumentCaptor<OnBeforeFinalizeFilterListener> mBeforeFilterListenerCaptor;
    @Captor
    private ArgumentCaptor<NotifInflater.Params> mParamsCaptor;
    @Mock
    ...
    @Mock
    private BindEventManagerImpl mBindEventManagerImpl;
    @Mock
    private NotificationLockscreenUserManager mLockscreenUserManager;
    @Spy
    private FakeNotifInflater mNotifInflater = new FakeNotifInflater();
