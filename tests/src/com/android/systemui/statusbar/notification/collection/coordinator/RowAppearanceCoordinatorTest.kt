...
class RowAppearanceCoordinatorTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var assistantFeedbackController: AssistantFeedbackController
    @Mock
    private lateinit var sectionClassifier: SectionClassifier

    @Mock
    private lateinit var section1: NotifSection
    @Mock
    private lateinit var section2: NotifSection
    @Mock
    private lateinit var controller1: NotifRowController
    @Mock
    private lateinit var controller2: NotifRowController
