...
public class ShadeListBuilderTest extends SysuiTestCase {
    ...
    @Mock
    private ShadeListBuilderLogger mLogger;
    @Mock
    ...
    @Spy
    private OnBeforeTransformGroupsListener mOnBeforeTransformGroupsListener;
    @Spy
    private OnBeforeSortListener mOnBeforeSortListener;
    @Spy
    private OnBeforeFinalizeFilterListener mOnBeforeFinalizeFilterListener;
    @Spy
    private OnBeforeRenderListListener mOnBeforeRenderListListener;
    @Captor
    private ArgumentCaptor<CollectionReadyForBuildListener> mBuildListenerCaptor;
    ...
    @Spy
    private OnRenderListListener mOnRenderListListener = list -> mBuiltList = list;
     ...
     *
     * @param index     Index of this notification in the set. This must be the current size of
     *                  the set.
     *                  it exists to improve readability of the resulting code, since later tests
     *                  will
