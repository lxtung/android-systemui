...
class RenderStageManagerTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var shadeListBuilder: ShadeListBuilder
    @Mock
    private lateinit var onAfterRenderListListener: OnAfterRenderListListener
    @Mock
    private lateinit var onAfterRenderGroupListener: OnAfterRenderGroupListener
    @Mock
    private lateinit var onAfterRenderEntryListener: OnAfterRenderEntryListener
