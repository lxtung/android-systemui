...
public class NotifCollectionTest extends SysuiTestCase {
    ...
    @Mock
    private NotifCollectionLogger mLogger;
    @Mock
    private LogBufferEulogizer mEulogizer;
    @Mock
    private Handler mMainHandler;
    @Mock
    private GroupCoalescer mGroupCoalescer;
    @Spy
    private RecordingCollectionListener mCollectionListener;
    @Mock
    private CollectionReadyForBuildListener mBuildListener;
    @Spy
    private RecordingLifetimeExtender mExtender1 = new RecordingLifetimeExtender("Extender1");
    @Spy
    private RecordingLifetimeExtender mExtender2 = new RecordingLifetimeExtender("Extender2");
    @Spy
    private RecordingLifetimeExtender mExtender3 = new RecordingLifetimeExtender("Extender3");
    @Spy
    private RecordingDismissInterceptor mInterceptor1 = new RecordingDismissInterceptor(
            "Interceptor1");
    @Spy
    private RecordingDismissInterceptor mInterceptor2 = new RecordingDismissInterceptor(
            "Interceptor2");
    @Spy
    private RecordingDismissInterceptor mInterceptor3 = new RecordingDismissInterceptor(
            "Interceptor3");
    @Captor
    private ArgumentCaptor<BatchableNotificationHandler> mListenerCaptor;
    @Captor
    private ArgumentCaptor<NotificationEntry> mEntryCaptor;
    @Captor
    private ArgumentCaptor<Collection<NotificationEntry>> mBuildListCaptor;
