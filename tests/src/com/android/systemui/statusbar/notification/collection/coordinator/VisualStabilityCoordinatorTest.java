...
public class VisualStabilityCoordinatorTest extends SysuiTestCase {
    ...
    @Mock
    private Pluggable.PluggableListener<NotifStabilityManager> mInvalidateListener;
    @Mock
    private HeadsUpManager mHeadsUpManager;
    @Mock
    private NotifPanelEvents mNotifPanelEvents;
    @Mock
    private VisualStabilityProvider mVisualStabilityProvider;

    @Captor
    private ArgumentCaptor<WakefulnessLifecycle.Observer> mWakefulnessObserverCaptor;
    @Captor
    private ArgumentCaptor<StatusBarStateController.StateListener> mSBStateListenerCaptor;
    @Captor
    private ArgumentCaptor<NotifPanelEvents.Listener> mNotifPanelEventsCallbackCaptor;
    @Captor
    private ArgumentCaptor<NotifStabilityManager> mNotifStabilityManagerCaptor;
