...
class GutsCoordinatorTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var notifGutsViewManager: NotifGutsViewManager
    @Mock
    private lateinit var pipeline: NotifPipeline
    @Mock
    private lateinit var dumpManager: DumpManager
    @Mock
    private lateinit var logger: GutsCoordinatorLogger
    @Mock
    private lateinit var lifetimeExtenderCallback: OnEndLifetimeExtensionCallback
