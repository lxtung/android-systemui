...
class ChannelEditorDialogControllerTest : SysuiTestCase() {
    ...
    fun setup() {
        ...
        `when`(
            mockNoMan.getNotificationChannelGroupsForPackage(
    ...
    fun testPrepareDialogForApp_noExtraChannels() {
        ...
        controller.prepareDialogForApp(
            TEST_APP_NAME, TEST_PACKAGE_NAME, TEST_UID,
    ...
    fun testPrepareDialogForApp_onlyDefaultChannel() {
        ...
        assertEquals(
            "No channels should be shown when there is only the miscellaneous channel",
    ...
    fun testPrepareDialogForApp_retrievesUpTo4Channels() {
        ...
        assertEquals(
            "ChannelEditorDialog should fetch enough channels to show 4",
    ...
    fun testApply_demoteChannel() {
        ...
        assertEquals(
            "Proposed edits should take effect after apply",
