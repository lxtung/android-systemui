...
public class NotificationEntryManagerInflationTest extends SysuiTestCase {
    ...
    @Mock
    private NotificationRowBinderImpl.BindRowCallback mBindCallback;
    @Mock
    ...
    @Mock
    private ExpandableNotificationRowComponent mExpandableNotificationRowComponent;
    @Mock
    ...
    @Mock
    private NotificationGroupManagerLegacy mGroupMembershipManager;
    @Mock
    private NotificationGroupManagerLegacy mGroupExpansionManager;
    @Mock
    ...
    @Mock
    private ActivatableNotificationViewController mActivatableNotificationViewController;
    @Mock
    private NotificationRowComponent.Builder mNotificationRowComponentBuilder;
    @Mock
    private PeopleNotificationIdentifier mPeopleNotificationIdentifier;
    @Mock
    private InflatedSmartReplyState mInflatedSmartReplyState;
    @Mock
    private InflatedSmartReplyViewHolder mInflatedSmartReplies;
