...
class IconManagerTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var shortcut: ShortcutInfo
    @Mock
    private lateinit var shortcutIc: Icon
    @Mock
    private lateinit var messageIc: Icon
    @Mock
    private lateinit var largeIc: Icon
    @Mock
    private lateinit var smallIc: Icon
    @Mock
    ...
    @Mock
    private lateinit var notifCollection: CommonNotifCollection
    @Mock
