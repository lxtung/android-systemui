...
class UserSwitcherControllerTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var telephonyListenerManager: TelephonyListenerManager
    @Mock
    ...
    @Mock
    private lateinit var dialogShower: UserSwitchDialogController.DialogShower
    @Mock
    private lateinit var notificationShadeWindowView: NotificationShadeWindowView
    @Mock
    private lateinit var threadedRenderer: ThreadedRenderer
    @Mock
    ...
    private val ownerInfo = UserInfo(
        ownerId, "Owner", null,
    ...
    private val guestInfo = UserInfo(
        guestId, "Guest", null,
