...
public class NotificationTapHelperTest extends SysuiTestCase {
    ...
    private View mView;
    @Mock
    private NotificationTapHelper.ActivationListener mActivationListener;
    @Mock
    private NotificationTapHelper.DoubleTapListener mDoubleTapListener;
    @Mock
    private NotificationTapHelper.SlideBackListener mSlideBackListener;
    @Mock
