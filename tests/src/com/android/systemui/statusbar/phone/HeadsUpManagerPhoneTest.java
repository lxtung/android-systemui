...
public class HeadsUpManagerPhoneTest extends AlertingNotificationManagerTest {
    ...
    @Mock
    private HeadsUpManagerLogger mHeadsUpManagerLogger;
    @Mock
    private NotificationGroupManagerLegacy mGroupManager;
    @Mock
    private View mNotificationShadeWindowView;
    @Mock
    private VisualStabilityProvider mVSProvider;
    @Mock
    private StatusBarStateController mStatusBarStateController;
    @Mock
    private KeyguardBypassController mBypassController;
    @Mock
    private ConfigurationControllerImpl mConfigurationController;
