...
public class NotificationRemoteInputManagerTest extends SysuiTestCase {
    ...
    @Mock
    private RemoteInputController.Delegate mDelegate;
    @Mock
    private NotificationRemoteInputManager.Callback mCallback;
    @Mock
    ...
    @Mock
    private StatusBarStateController mStateController;
    @Mock
