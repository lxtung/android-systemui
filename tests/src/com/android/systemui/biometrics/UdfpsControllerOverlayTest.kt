...
class UdfpsControllerOverlayTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var dialogManager: SystemUIDialogManager
    @Mock
    ...
    @Mock
    private lateinit var hbmProvider: UdfpsHbmProvider
    @Mock
    private lateinit var controllerCallback: IUdfpsOverlayControllerCallback
    @Mock
    private lateinit var udfpsController: UdfpsController
    @Mock
    private lateinit var udfpsView: UdfpsView
    @Mock
    private lateinit var udfpsEnrollView: UdfpsEnrollView
    @Mock
    private lateinit var activityLaunchAnimator: ActivityLaunchAnimator
    @Captor
    private lateinit var layoutParamsCaptor: ArgumentCaptor<WindowManager.LayoutParams>
