...
public class PluginManagerTest extends SysuiTestCase {
    ...
    @Mock
    PluginActionManager.Factory mMockFactory;
    @Mock
    PluginActionManager<TestPlugin> mMockPluginInstance;
    @Mock
    PluginListener<TestPlugin> mMockListener;
    @Mock
    PackageManager mMockPackageManager;
    @Mock
    PluginEnabler mMockPluginEnabler;
    @Mock
    PluginPrefs mMockPluginPrefs;
    @Mock
    UncaughtExceptionPreHandlerManager mMockExPreHandlerManager;

    @Captor
    ArgumentCaptor<UncaughtExceptionHandler> mExPreHandlerCaptor;
