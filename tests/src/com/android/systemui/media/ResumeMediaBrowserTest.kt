...
public class ResumeMediaBrowserTest : SysuiTestCase() {
    ...
    @Mock
    lateinit var callback: ResumeMediaBrowser.Callback
    @Mock
    lateinit var listener: MediaResumeListener
    @Mock
    lateinit var service: MediaBrowserService
    @Mock
    lateinit var logger: ResumeMediaBrowserLogger
    @Mock
    lateinit var browserFactory: MediaBrowserFactory
    @Mock
    ...
    @Captor
    lateinit var connectionCallback: ArgumentCaptor<MediaBrowser.ConnectionCallback>
    @Captor
    lateinit var subscriptionCallback: ArgumentCaptor<MediaBrowser.SubscriptionCallback>
    @Captor
    lateinit var mediaControllerCallback: ArgumentCaptor<MediaController.Callback>
