...
class SeekBarObserverTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var mockSeekbarAnimator: ObjectAnimator
    @Mock
    private lateinit var mockHolder: MediaViewHolder
    @Mock
    private lateinit var mockSquigglyProgress: SquigglyProgress
