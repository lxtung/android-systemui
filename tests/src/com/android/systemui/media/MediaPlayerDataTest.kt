...
public class MediaPlayerDataTest : SysuiTestCase() {
    ...
    fun addPlayingThenRemote() {
        ...
        MediaPlayerData.addMediaPlayer(
            "2", dataIsRemote, playerIsRemote, systemClock,
            isSsReactivated = false
        )
        MediaPlayerData.addMediaPlayer(
            "1", dataIsPlaying, playerIsPlaying, systemClock,
            isSsReactivated = false
        )
    ...
    fun switchPlayersPlaying() {
        ...
        MediaPlayerData.addMediaPlayer(
            "1", dataIsPlaying1, playerIsPlaying1, systemClock,
            isSsReactivated = false
        )
        systemClock.advanceTime(1)
        MediaPlayerData.addMediaPlayer(
            "2", dataIsPlaying2, playerIsPlaying2, systemClock,
            isSsReactivated = false
        )
        systemClock.advanceTime(1)
    ...
    fun fullOrderTest() {
        ...
        MediaPlayerData.addMediaPlayer(
            "4", dataCanResume, playerCanResume, systemClock,
            isSsReactivated = false
        )
        MediaPlayerData.addMediaPlayer(
            "1", dataIsPlaying, playerIsPlaying, systemClock,
        ...
        MediaPlayerData.addMediaPlayer(
            "6", dataUndetermined, playerUndetermined, systemClock,
            isSsReactivated = false
        )
        ...
        assertThat(players).containsExactly(
            playerIsPlaying, playerIsPlayingAndRemote,
    ...
    fun testMoveMediaKeysAround() {
        ...
        MediaPlayerData.addMediaPlayer(
            keyA, data, playerIsPlaying, systemClock,
            isSsReactivated = false
        )
        systemClock.advanceTime(1)
        ...
        MediaPlayerData.addMediaPlayer(
            keyB, data, playerIsPlaying, systemClock,
            isSsReactivated = false
        )
        systemClock.advanceTime(1)
