...
public class MediaControlPanelTest : SysuiTestCase() {
    ...
    @Mock
    private lateinit var gutsViewHolder: GutsViewHolder
    @Mock
    private lateinit var viewHolder: MediaViewHolder
    @Mock
    private lateinit var view: TransitionLayout
    @Mock
    private lateinit var seekBarViewModel: SeekBarViewModel
    @Mock
    private lateinit var seekBarData: LiveData<SeekBarViewModel.Progress>
    @Mock
    ...
    @Mock
    private lateinit var transitionParent: ViewGroup
    ...
    @Mock
    private lateinit var seamlessBackground: RippleDrawable
    ...
    @Mock
    private lateinit var gutsText: TextView
    @Mock
    private lateinit var mockAnimator: AnimatorSet
    ...
    @Mock
    private lateinit var instanceId: InstanceId
    @Mock
    ...
    @Mock
    private lateinit var activityIntentHelper: ActivityIntentHelper
    @Mock
    private lateinit var lockscreenUserManager: NotificationLockscreenUserManager

    @Mock
    private lateinit var recommendationViewHolder: RecommendationViewHolder
    @Mock
    private lateinit var smartspaceAction: SmartspaceAction
    private lateinit var smartspaceData: SmartspaceMediaData
    @Mock
    private lateinit var coverContainer1: ViewGroup
    @Mock
    private lateinit var coverContainer2: ViewGroup
    @Mock
    private lateinit var coverContainer3: ViewGroup
