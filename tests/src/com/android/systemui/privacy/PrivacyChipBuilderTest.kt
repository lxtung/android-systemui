...
class PrivacyChipBuilderTest : SysuiTestCase() {
    ...
    fun testGenerateAppsList() {
        val bar2 = PrivacyItem(
            Privacy.TYPE_CAMERA, PrivacyApplication(
                "Bar", TEST_UID
            )
        )
        val bar3 = PrivacyItem(
            Privacy.TYPE_LOCATION, PrivacyApplication(
                "Bar", TEST_UID
            )
        )
        val foo0 = PrivacyItem(
            Privacy.TYPE_MICROPHONE, PrivacyApplication(
                "Foo", TEST_UID
            )
        )
        val baz1 = PrivacyItem(
            Privacy.TYPE_CAMERA, PrivacyApplication(
                "Baz", TEST_UID
            )
        )
