...
class RemoteTransitionAdapter {
    companion object {
        ...
        private fun setupLeash(
            ...
            t.setPosition(
                leash, (change.startAbsBounds.left - info.rootOffset.x).toFloat(), (
        ...
        private fun createLeash(
            ...
            val leashSurface = SurfaceControl.Builder()
                ...
                .setContainerLayer().setParent(
                    if (change.parent == null)
                        info.rootLeash else info.getChange(change.parent!!)!!.leash
                ).build()
                ...
                override fun startAnimation(
                    ...
                    if (launcherTask != null && rotateDelta != 0 && launcherTask.parent != null) {
                        counterLauncher.setup(
                            t, info.getChange(launcherTask.parent!!)!!.leash,
                    ...
                    if (isReturnToHome) {
                        ...
                        if (wallpaper != null && rotateDelta != 0 && wallpaper.parent != null) {
                            counterWallpaper.setup(
                                t, info.getChange(wallpaper.parent!!)!!.leash,
                                rotateDelta, displayW, displayH
                            )
                    ...
                    val animationFinishedCallback = object : IRemoteAnimationFinishedCallback {
                        override fun onAnimationFinished() {
                            ...
                            try {
                                ...
                                Log.e(
                                    "ActivityOptionsCompat", "Failed to call app controlled" +
