...
class ActivityLaunchAnimator(
    ...
    fun startIntentWithAnimation(
        ...
        Log.i(
            TAG, "launchResult=$launchResult willAnimate=$willAnimate " +
    ...
    inner class Runner(private val controller: Controller) : IRemoteAnimationRunner.Stub() {
        ...
        private fun applyStateToNavigationBar(
            ...
            val fadeInProgress = LaunchAnimator.getProgress(
                TIMINGS, linearProgress,
            ...
            if (fadeInProgress > 0) {
                ...
                val fadeOutProgress = LaunchAnimator.getProgress(
                    TIMINGS, linearProgress, 0,
