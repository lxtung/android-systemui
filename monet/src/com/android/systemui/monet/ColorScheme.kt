...
internal class HueVibrantSecondary : Hue {
    val hueToRotations = listOf(
        Pair(0, 18), Pair(41, 15), Pair(61, 10), Pair(101, 12),
...
internal class HueVibrantTertiary : Hue {
    val hueToRotations = listOf(
        Pair(0, 35), Pair(41, 30), Pair(61, 20), Pair(101, 25),
...
internal class HueExpressiveSecondary : Hue {
    val hueToRotations = listOf(
        Pair(0, 45), Pair(21, 95), Pair(51, 45), Pair(121, 20),
...
internal class HueExpressiveTertiary : Hue {
    val hueToRotations = listOf(
        Pair(0, 120), Pair(21, 120), Pair(51, 20), Pair(121, 45),
