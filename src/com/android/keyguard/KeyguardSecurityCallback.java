...
public interface KeyguardSecurityCallback {
     ...
     *
     * @param securityVerified     true if the user correctly entered credentials for the given
     *                             screen.
     ...
     * Dismiss the given security screen.
     *
     * @param securityVerified          true if the user correctly entered credentials for the
     *                                  given screen.
     * @param targetUserId              a user that needs to be the foreground user at the
