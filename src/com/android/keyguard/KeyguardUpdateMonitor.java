...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener, Dumpable {
    ...
    private int mFaceRunningState = BIOMETRIC_STATE_STOPPED;    private final Runnable mFpCancelNotReceived = () -> {
    ...
    private boolean mIsFaceAuthUserRequested;    private final Runnable mFaceCancelNotReceived = () -> {
    ...
    private boolean mIsDreaming;    private final IBiometricEnabledOnKeyguardCallback mBiometricEnabledCallback =
    ...
    private final SparseBooleanArray mUserFaceUnlockRunning = new SparseBooleanArray();
    private final Map<Integer, Intent> mSecondaryLockscreenRequirement = new HashMap<Integer, Intent>();
    private final DisplayClientState mDisplayClientState = new DisplayClientState();
