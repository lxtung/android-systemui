...
public class PasswordTextView extends View {
    ...
    private final ArrayList<CharState> mTextChars = new ArrayList<>();
    private String mText = "";
    private final Stack<CharState> mCharPool = new Stack<>();
    private final int mDotSize;
    private final PowerManager mPM;
    private final int mCharPadding;
    private final Interpolator mAppearInterpolator;
    private final Interpolator mDisappearInterpolator;
    private final Interpolator mFastOutSlowInInterpolator;
    private final boolean mShowPassword;
    ...
    private class CharState {
        ...
        private final ValueAnimator.AnimatorUpdateListener dotSizeUpdater
        ...
        private final ValueAnimator.AnimatorUpdateListener textSizeUpdater
                = new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        private final Runnable dotSwapperRunnable = new Runnable() {
            @Override
            public void run() {
                performSwap();
        ...
        private final ValueAnimator.AnimatorUpdateListener textTranslationUpdater
                = new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        private final ValueAnimator.AnimatorUpdateListener widthUpdater
                = new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
