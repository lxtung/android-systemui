...
public class KeyguardSecurityContainerController extends ViewController<KeyguardSecurityContainer>
    ...
    private final KeyguardSecurityCallback mKeyguardSecurityCallback = new KeyguardSecurityCallback() {
     ...
     * @param expectedSecurityMode      SecurityMode that is invoking this request. SecurityMode
     *                                  .Invalid
