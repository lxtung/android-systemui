...
public class SensorLoggerSession {
    ...
    private final ArrayList<TouchEvent> mMotionEvents = new ArrayList<>();
    private final ArrayList<SensorEvent> mSensorEvents = new ArrayList<>();
    private final ArrayList<PhoneEvent> mPhoneEvents = new ArrayList<>();
    ...
    public String toString() {
        String sb = "Session{" + "mStartTimestampMillis=" + mStartTimestampMillis +
                ", mStartSystemTimeNanos=" + mStartSystemTimeNanos +
                ", mEndTimestampMillis=" + mEndTimestampMillis +
                ", mResult=" + mResult +
                ", mTouchAreaHeight=" + mTouchAreaHeight +
                ", mTouchAreaWidth=" + mTouchAreaWidth +
                ", mMotionEvents=[size=" + mMotionEvents.size() + "]" +
                ", mSensorEvents=[size=" + mSensorEvents.size() + "]" +
                ", mPhoneEvents=[size=" + mPhoneEvents.size() + "]" +
                '}';
        return sb;
    }
