...
public class AuthBiometricView extends LinearLayout {
    ...
    @VisibleForTesting
    int mAnimationDurationShort = AuthDialog.ANIMATE_SMALL_TO_MEDIUM_DURATION_MS;
    @VisibleForTesting
    int mAnimationDurationLong = AuthDialog.ANIMATE_MEDIUM_TO_LARGE_DURATION_MS;
    @VisibleForTesting
    int mAnimationDurationHideDialog = BiometricPrompt.HIDE_DIALOG_DELAY;
    ...
    final void updateSize(@AuthDialog.DialogSize int newSize) {
        ...
        if (newSize == AuthDialog.SIZE_SMALL) {
            ...
            as.setDuration(mAnimationDurationLong * 2L / 3);
            as.start();
        } else {
