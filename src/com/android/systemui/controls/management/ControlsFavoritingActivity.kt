    ...
    private fun loadControls() {
        component?.let {
            ...
            controller.loadForComponent(it, Consumer { data ->
                ...
                val structureIndex = listOfStructures.indexOfFirst { sc ->
                    sc.structureName == structureExtra
                ...
                executor.execute {
                    ...
                    structurePager.currentItem = structureIndex
                    if (error) {
                        statusText.text = resources.getString(
