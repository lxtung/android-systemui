...
class DetailDialog(
    ...
    val stateCallback = object : TaskView.Listener {
        override fun onInitialized() {
            taskViewContainer.apply {
                ...
                val lp = layoutParams
                lp.width = (width * taskWidthPercentWidth).toInt()
                layoutParams = lp
            }
    ...
    init {
        ...
        window?.getDecorView()?.setOnApplyWindowInsetsListener { v: View, insets: WindowInsets ->
            val l = v.paddingLeft
        ...
        if (ScreenDecorationsUtils.supportsRoundedCornersOnWindows(context.resources)) {
