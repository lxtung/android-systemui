...
class ToggleBehavior : Behavior {
    ...
    override fun initialize(cvh: ControlViewHolder) {
        ...
        cvh.layout.setOnClickListener(View.OnClickListener {
            cvh.controlActionCoordinator.toggle(cvh, template.templateId, template.isChecked)
        })
    }
    ...
    override fun bind(cws: ControlWithState, colorOffset: Int) {
        ...
        val controlTemplate = control.controlTemplate
        template = when (controlTemplate) {
            is ToggleTemplate -> controlTemplate
            is TemperatureControlTemplate -> controlTemplate.template as ToggleTemplate
            else -> {
