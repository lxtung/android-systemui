...
public class BatteryControllerImpl extends BroadcastReceiver implements BatteryController {
    ...
    // as this controller.
    private final AtomicReference<WeakReference<View>> mPowerSaverStartView = new AtomicReference<>();
    ...
    public void dump(PrintWriter pw, String[] args) {
        ...
        pw.print("  mStateUnknown=");
        pw.println(mStateUnknown);
    }
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
            ...
            mMainHandler.post(new Runnable() {
                int mCurrentLevel = 0;
                int mIncrement = 1;
                final int mSavedLevel = mLevel;
                final boolean mSavedPluggedIn = mPluggedIn;
                final Intent mTestIntent = new Intent(Intent.ACTION_BATTERY_CHANGED);
