...
public class UserSwitcherController implements Dumpable {
    ...
    private final Intent mSecondaryUserServiceIntent;
    private final SparseBooleanArray mForcePictureLoadForUserId = new SparseBooleanArray(2);
    private final FalsingManager mFalsingManager;
    private View mView;
    private final String mCreateSupervisedUserPackage;
    ...
    private final List<UserSwitchCallback> mUserSwitchCallbacks =
     ...
     *                     UserHandle.USER_NULL}, then switch immediately to the newly created
     *                     guest user.
     */
