...
import com.android.systemui.statusbar.DisableFlagsLogger.DisableFlag
...
// LINT.IfChange
private val defaultDisable1FlagsList: List<DisableFlag> = listOf(
    DisableFlag(DISABLE_EXPAND, 'E', 'e'),
    DisableFlag(DISABLE_NOTIFICATION_ICONS, 'N', 'n'),
    DisableFlag(DISABLE_NOTIFICATION_ALERTS, 'A', 'a'),
    DisableFlag(DISABLE_SYSTEM_INFO, 'I', 'i'),
    DisableFlag(DISABLE_HOME, 'H', 'h'),
    DisableFlag(DISABLE_BACK, 'B', 'b'),
    DisableFlag(DISABLE_CLOCK, 'C', 'c'),
    DisableFlag(DISABLE_RECENT, 'R', 'r'),
    DisableFlag(DISABLE_SEARCH, 'S', 's'),
    DisableFlag(DISABLE_ONGOING_CALL_CHIP, 'O', 'o')
)

private val defaultDisable2FlagsList: List<DisableFlag> = listOf(
    DisableFlag(DISABLE2_QUICK_SETTINGS, 'Q', 'q'),
    DisableFlag(DISABLE2_SYSTEM_ICONS, 'I', 'i'),
    DisableFlag(DISABLE2_NOTIFICATION_SHADE, 'N', 'n'),
    DisableFlag(DISABLE2_GLOBAL_ACTIONS, 'G', 'g'),
    DisableFlag(DISABLE2_ROTATE_SUGGESTIONS, 'R', 'r')
)
