...
public class MessagingLayoutTransformState extends TransformState {
    ...
    private static final Pools.SimplePool<MessagingLayoutTransformState> sInstancePool
            = new Pools.SimplePool<>(40);
    private MessagingLinearLayout mMessageContainer;
    private IMessagingLayout mMessagingLayout;
    private final HashMap<MessagingGroup, MessagingGroup> mGroupMap = new HashMap<>();
    ...
    private boolean isGone(View view) {
        ...
        return lp instanceof MessagingLinearLayout.LayoutParams
