...
class ViewGroupFadeHelper {
    companion object {
        private val visibilityIncluder = { view: View ->
         ...
         */
        @JvmStatic
        fun fadeOutAllChildrenExcept(
            root: ViewGroup, excludedView: View, duration: Long,
            ...
            val animator = ValueAnimator.ofFloat(1.0f, 0.0f).apply {
                ...
                addUpdateListener { animation ->
                    val previousSetAlpha = root.getTag(
                        R.id.view_group_fade_helper_previous_value_tag
                    ) as Float?
                    ...
                    for (viewToFade in viewsToFadeOut) {
                        if (viewToFade.alpha != previousSetAlpha) {
                            ...
                            // it at the end
                            viewToFade.setTag(
                                R.id.view_group_fade_helper_restore_tag,
                                viewToFade.alpha
                            )
                        }
        ...
        private fun gatherViews(
            root: ViewGroup, excludedView: View,
            shouldInclude: (View) -> Boolean
        ): MutableSet<View> {
        ...
        fun reset(root: ViewGroup) {
            ...
            for (viewToFade in modifiedViews) {
                ...
                val needsLayerReset = viewToFade.getTag(
                    R.id.view_group_fade_helper_hardware_layer
                ) as Boolean?
