...
interface SectionHeaderControllerSubcomponent {
    ...
    interface Builder {
        ...
        @BindsInstance
        fun nodeLabel(@NodeLabel nodeLabel: String): Builder
        @BindsInstance
        fun headerText(@HeaderText @StringRes headerText: Int): Builder
        @BindsInstance
        fun clickIntentAction(@HeaderClickAction clickIntentAction: String): Builder
    }
}
...
private abstract class SectionHeaderBindingModule {
    @Binds
    abstract fun bindsNodeController(impl: SectionHeaderNodeControllerImpl): NodeController
    @Binds
