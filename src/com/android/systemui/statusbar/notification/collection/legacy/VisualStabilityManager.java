...
public class VisualStabilityManager implements OnHeadsUpChangedListener, Dumpable {
    ...
    private final ArraySet<View> mAllowedReorderViews = new ArraySet<>();
    private final ArraySet<NotificationEntry> mLowPriorityReorderingViews = new ArraySet<>();
    private final ArraySet<View> mAddedChildren = new ArraySet<>();
    ...
    public boolean canReorderNotification(ExpandableNotificationRow row) {
        ...
        return mAllowedReorderViews.contains(row)
    ...
    public void dump(PrintWriter pw, String[] args) {
        ...
        pw.println(mIsTemporaryReorderingAllowed);
        pw.print("  mTemporaryReorderingStart=");
        pw.println(mTemporaryReorderingStart);
