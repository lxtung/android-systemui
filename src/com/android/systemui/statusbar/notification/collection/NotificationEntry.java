...
public final class NotificationEntry extends ListEntry {
     ...
     */
    @CancellationReason
    int mCancellationReason = REASON_NOT_CANCELED;
    ...
    private final List<OnSensitivityChangedListener> mOnSensitivityChangedListeners = new ArrayList<>();
    ...
    public boolean isBlockable() {
        ...
        return !getChannel().isImportanceLockedByCriticalDeviceFunction()
