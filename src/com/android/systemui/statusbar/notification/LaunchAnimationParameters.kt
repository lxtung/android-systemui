...
class LaunchAnimationParameters(
    ...
    override val topChange: Int
        get() {
            ...
            if (startClipTopAmount.toFloat() != 0.0f) {
                clipTopAmountCompensation = MathUtils.lerp(
                    0f, startClipTopAmount.toFloat(),
    ...
    fun getProgress(delay: Long, duration: Long): Float {
        return LaunchAnimator.getProgress(
            ActivityLaunchAnimator.TIMINGS, linearProgress, delay,
            duration
        )
    }
}