...
public interface NotificationEntryListener {
     ...
     *
     * @param entry         notification data entry that was removed.  Null if no entry existed
     *                      for the
     *                      removed key at the time of removal.
     * @param visibility    logging data related to the visibility of the notification at the
     *                      time of
     *                      removal, if it was removed by a user action.  Null if it was not
     *                      removed by
     *                      a user action.
