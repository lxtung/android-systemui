...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener,
    ...
    private final ArrayList<MenuItem> mLeftMenuItems;
    private final ArrayList<MenuItem> mRightMenuItems;
    ...
    private final boolean mShouldShowMenu;
