...
public abstract class ExpandableView extends FrameLayout implements Dumpable {
    ...
    private static final Rect mClipRect = new Rect();
    ...
    private final ArrayList<View> mMatchParentViews = new ArrayList<View>();
     ...
     * @param endLocation          The location where the horizonal heads up disappear animation
     *                             should end.
    ...
    public abstract long performRemoveAnimation(long duration,
                                                long delay, float translationDirection,
                                                boolean isHeadsUpAnimation, float endLocation,
    ...
    public interface OnHeightChangedListener {
        ...
        /**
         * @param view           the view for which the height changed, or {@code null} if just
         *                       the top
