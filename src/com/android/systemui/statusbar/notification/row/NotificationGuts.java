...
public class NotificationGuts extends FrameLayout {
    ...
    private final View.AccessibilityDelegate mGutsContentAccessibilityDelegate =
    ...
    public interface GutsContent {
        ...
        void setGutsParent(NotificationGuts listener);
         ...
         */
        boolean handleCloseControls(boolean save, boolean force);
    ...
    public interface OnGutsClosedListener {
        void onGutsClosed(NotificationGuts guts);
    }

    public interface OnHeightChangedListener {
        void onHeightChanged(NotificationGuts guts);
    }
