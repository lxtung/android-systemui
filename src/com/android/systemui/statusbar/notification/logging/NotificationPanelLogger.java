...
public interface NotificationPanelLogger {
    ...
    static int toNotificationSection(@PriorityBucket int bucket) {
        switch (bucket) {
            case BUCKET_MEDIA_CONTROLS:
                return Notifications.Notification.SECTION_MEDIA_CONTROLS;
            case BUCKET_HEADS_UP:
                return Notifications.Notification.SECTION_HEADS_UP;
            ...
            case BUCKET_ALERTING:
                return Notifications.Notification.SECTION_ALERTING;
            case BUCKET_SILENT:
                return Notifications.Notification.SECTION_SILENT;
        }
