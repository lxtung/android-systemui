...
public class StackStateAnimator {
    ...
    private final ArrayList<NotificationStackScrollLayout.AnimationEvent> mNewEvents =
            new ArrayList<>();
    private final ArrayList<View> mNewAddChildren = new ArrayList<>();
    private final HashSet<View> mHeadsUpAppearChildren = new HashSet<>();
    private final HashSet<View> mHeadsUpDisappearChildren = new HashSet<>();
    private final HashSet<Animator> mAnimatorSet = new HashSet<>();
    private final Stack<AnimatorListenerAdapter> mAnimationListenerPool = new Stack<>();
    ...
    private final ArrayList<ExpandableView> mTransientViewsToRemove = new ArrayList<>();
    ...
    private void adaptDurationWhenGoingToFullShade(ExpandableView child,
                                                   ...
                                                   boolean wasAdded, int animationStaggerCount) {
