...
public class ViewTransformationHelper implements TransformableView,
    ...
    private final ArrayMap<Integer, View> mTransformedViews = new ArrayMap<>();
    private final ArraySet<Integer> mKeysTransformingToSimilar = new ArraySet<>();
    private final ArrayMap<Integer, CustomTransformation> mCustomTransformations = new ArrayMap<>();
