...
public class CentralSurfacesImpl extends CoreStartable implements
    ...
    private static int getLoggingFingerprint(int statusBarState, boolean keyguardShowing,
                                             boolean keyguardOccluded, boolean bouncerShowing,
            boolean secure,
...
"report")
    ...
    public void dump(PrintWriter pwOriginal, String[] args) {
        ...
        pw.println(mWallpaperSupported);
    ...
    public void startActivityDismissingKeyguard(final Intent intent, boolean onlyProvisioned,
                                                final boolean dismissShade,
                                                 final boolean disallowEnterPictureInPictureWhileLaunching,
    ...
    private void logStateToEventlog() {
        ...
        if (stateFingerprint != mLastLoggedStateFingerprint) {
            ...
            String uiEventValueBuilder = (isBouncerShowing ? "BOUNCER" : "LOCKSCREEN") +
                    (isShowing ? "_OPEN" : "_CLOSE") +
                    (isSecure ? "_SECURE" : "_INSECURE");
            sUiEventLogger.log(StatusBarUiEvent.valueOf(uiEventValueBuilder));
        }
    }
     ...
     * @param collapsePanel         Whether we should collapse the panel after dismissing the
     *                              keyguard.
