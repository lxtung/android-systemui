...
public class NotificationGroupAlertTransferHelper implements OnHeadsUpChangedListener,
    ...
    private final NotificationEntryListener mNotificationEntryListener =
            new NotificationEntryListener() {
                // Called when a new notification has been posted but is not inflated yet. We use
                // this to
                ...
                public void onPendingEntryAdded(NotificationEntry entry) {
                    ...
                    if (groupAlertEntry != null && groupAlertEntry.mGroup.alertOverride == null) {
                        // new pending group entries require us to transfer back from the child
                        // to the
                        // group, but alertOverrides are only present in very limited
                        // circumstances, so
                        // while it's possible the group should ALSO alert, the previous
                        // detection which set
                        // this alertOverride won't be invalidated by this notification added to
                        // this group.
                ...
                public void onEntryRemoved(
                        ...
                        int reason) {
                    // Removes any alerts pending on this entry. Note that this will not stop any
                    // inflation
    ...
    private class PendingAlertInfo {
        ...
        private boolean isStillValid() {
            ...
            return mEntry.getSbn().getNotification().isGroupSummary() == mOriginalNotification.getNotification().isGroupSummary();
        }
    }
}
