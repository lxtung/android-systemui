...
public class KeyguardIndicationTextView extends TextView {
    @StyleRes
    private static final int sStyleId = R.style.TextAppearance_Keyguard_BottomArea;
    @StyleRes
    private static final int sButtonStyleId = R.style.TextAppearance_Keyguard_BottomArea_Button;
     ...
     * @param animate                whether to animate this indication in - we may not want this
     *                              on AOD
