...
public class StatusIconContainer extends AlphaOptimizedLinearLayout {
    ...
    private static final AnimationProperties ANIMATE_ALL_PROPERTIES = new AnimationProperties() {
        private final AnimationFilter mAnimationFilter = new AnimationFilter().animateX().animateY()
    ...
    private final ArrayList<StatusIconState> mLayoutStates = new ArrayList<>();
    // So we can count and measure properly
    private final ArrayList<View> mMeasureViews = new ArrayList<>();
    ...
    private void initDimens() {
        ...
        mUnderflowWidth = mIconDotFrameWidth + 0;
    }
