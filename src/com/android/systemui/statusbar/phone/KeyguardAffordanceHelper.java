...
public class KeyguardAffordanceHelper {
    ...
    private final AnimatorListenerAdapter mFlingEndListener = new AnimatorListenerAdapter() {
        @Override
    ...
    private final Runnable mAnimationEndRunnable = new Runnable() {
        @Override
        public void run() {
    ...
    public void launchAffordance(boolean animate, boolean left) {
        ...
        if (animate) {
            ...
            mTranslation = mCallback.getMaxTranslationDistance();
