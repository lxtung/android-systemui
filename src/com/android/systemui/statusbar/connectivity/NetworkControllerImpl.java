                ...
                new WifiManager.ScanResultsCallback() {
                    ...
                    public void onScanResultsAvailable() {
                        ...
                        if (mNoDefaultNetwork) {
                            mCallbackHandler.setConnectivityStatus(mNoDefaultNetwork,
                                    !mInetCondition,
        ...
        NetworkCallback callback =
                new NetworkCallback(NetworkCallback.FLAG_INCLUDE_LOCATION_INFO) {
                    ...
                    public void onLost(Network network) {
                        ...
                        String callback = SSDF.format(System.currentTimeMillis()) + "," +
                                "onLost: " +
                                "network=" + network;
                    ...
                    public void onCapabilitiesChanged(
                        ...
                        // This callback is invoked a lot (i.e. when RSSI changes), so avoid
                        // updating
                        // icons when connectivity state has remained the same.
                        if (network.equals(mLastNetwork) && validated == lastValidated) {
                            // Should not rely on getTransportTypes() returning the same order of
                            // transport
