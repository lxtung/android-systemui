...
class MediaOutputDialogReceiver @Inject constructor(
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (TextUtils.equals(MediaOutputConstants.ACTION_LAUNCH_MEDIA_OUTPUT_DIALOG, intent.action)
        ) {
            val packageName = intent.getStringExtra(MediaOutputConstants.EXTRA_PACKAGE_NAME)
