...
open class SeekBarObserver(
    ...
    companion object {
        @JvmStatic
        val RESET_ANIMATION_DURATION_MS: Int = 750
        @JvmStatic
        val RESET_ANIMATION_THRESHOLD_MS: Int = 250
    }
    ...
    override fun onChanged(data: SeekBarViewModel.Progress) {
        ...
        holder.seekBar.max = data.duration
        ...
        data.elapsedTime?.let {
            if (!data.scrubbing && seekBarResetAnimator?.isRunning != true) {
