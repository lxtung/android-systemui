...
public class ForegroundServicesUserState {
    ...
    private final ArrayMap<String, ArraySet<String>> mImportantNotifications = new ArrayMap<>(1);
    // package -> standard layout posted notification keys that can display appOps
    private final ArrayMap<String, ArraySet<String>> mStandardLayoutNotifications = new ArrayMap<>(1);

    // package -> app ops
    private final ArrayMap<String, ArraySet<Integer>> mAppOps = new ArrayMap<>(1);
