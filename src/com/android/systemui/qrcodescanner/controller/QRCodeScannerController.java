...
public class QRCodeScannerController implements
    ...
    private final AtomicInteger mQRCodeScannerPreferenceChangeEvents = new AtomicInteger(0);
    private final AtomicInteger mDefaultQRCodeScannerChangeEvents = new AtomicInteger(0);
