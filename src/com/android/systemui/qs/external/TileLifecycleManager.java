...
public class TileLifecycleManager extends BroadcastReceiver implements
    ...
    private final Set<Integer> mQueuedMessages = new ArraySet<>();
    @Nullable
    ...
    private final AtomicBoolean mPackageReceiverRegistered = new AtomicBoolean(false);
    private final AtomicBoolean mUserReceiverRegistered = new AtomicBoolean(false);
    ...
    public static boolean isTileAdded(Context context, ComponentName component) {
        return context.getSharedPreferences(TILES, 0).getBoolean(component.flattenToString(),
                false);
    }
