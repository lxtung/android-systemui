...
public class InternetTile extends QSTileImpl<SignalState> {
    ...
    private void handleUpdateWifiState(SignalState state, Object arg) {
        ...
        if (DEBUG) {
            Log.d(TAG, "handleUpdateWifiState: " + "SignalState = " + state);
        }
    }
    ...
    private void handleUpdateCellularState(SignalState state, Object arg) {
        ...
        if (DEBUG) {
            Log.d(TAG, "handleUpdateCellularState: " + "SignalState = " + state);
        }
    }
    ...
    private void handleUpdateEthernetState(SignalState state, Object arg) {
        ...
        if (DEBUG) {
            Log.d(TAG, "handleUpdateEthernetState: " + "SignalState = " + state);
        }
    }
    ...
    public void dump(PrintWriter pw, String[] args) {
        ...
        pw.print("    ");
        pw.println("mLastTileState=" + mLastTileState);
        pw.print("    ");
        pw.println("mSignalCallback=" + mSignalCallback.toString());
    }
    ...
    private static final class EthernetCallbackInfo {
        ...
        public String toString() {
            return "EthernetCallbackInfo[" +
                    "mConnected=" + mConnected +
                    ",mEthernetSignalIconId=" + mEthernetSignalIconId +
                    ",mEthernetContentDescription=" + mEthernetContentDescription +
                    ']';
        }
    }
    ...
    private static final class WifiCallbackInfo {
        ...
        @Override
        public String toString() {
            return "WifiCallbackInfo[" +
                    "mAirplaneModeEnabled=" + mAirplaneModeEnabled +
                    ",mEnabled=" + mEnabled +
                    ",mConnected=" + mConnected +
                    ",mWifiSignalIconId=" + mWifiSignalIconId +
                    ",mSsid=" + mSsid +
                    ",mActivityIn=" + mActivityIn +
                    ",mActivityOut=" + mActivityOut +
                    ",mWifiSignalContentDescription=" + mWifiSignalContentDescription +
                    ",mIsTransient=" + mIsTransient +
                    ",mNoDefaultNetwork=" + mNoDefaultNetwork +
                    ",mNoValidatedNetwork=" + mNoValidatedNetwork +
                    ",mNoNetworksAvailable=" + mNoNetworksAvailable +
                    ']';
        }
    }
    ...
    private static final class CellularCallbackInfo {
        ...
        @Override
        public String toString() {
            return "CellularCallbackInfo[" +
                    "mAirplaneModeEnabled=" + mAirplaneModeEnabled +
                    ",mDataSubscriptionName=" + mDataSubscriptionName +
                    ",mDataContentDescription=" + mDataContentDescription +
                    ",mMobileSignalIconId=" + mMobileSignalIconId +
                    ",mQsTypeIcon=" + mQsTypeIcon +
                    ",mActivityIn=" + mActivityIn +
                    ",mActivityOut=" + mActivityOut +
                    ",mNoSim=" + mNoSim +
                    ",mRoaming=" + mRoaming +
                    ",mMultipleSubs=" + mMultipleSubs +
                    ",mNoDefaultNetwork=" + mNoDefaultNetwork +
                    ",mNoValidatedNetwork=" + mNoValidatedNetwork +
                    ",mNoNetworksAvailable=" + mNoNetworksAvailable +
                    ']';
    ...
    protected final class InternetSignalCallback implements SignalCallback {
        ...
        @Override
        public String toString() {
            return "InternetSignalCallback[" +
                    "mWifiInfo=" + mWifiInfo +
                    ",mCellularInfo=" + mCellularInfo +
                    ",mEthernetInfo=" + mEthernetInfo +
                    ']';
        }
    }
}
