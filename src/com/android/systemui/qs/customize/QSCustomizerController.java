...
public class QSCustomizerController extends ViewController<QSCustomizer> {
    ...
    protected QSCustomizerController(QSCustomizer view, TileQueryHelper tileQueryHelper,
                                     QSTileHost qsTileHost, TileAdapter tileAdapter,
        ...
        GridLayoutManager layout =
                new GridLayoutManager(getContext(), mTileAdapter.getNumColumns()) {
                    ...
                    public void calculateItemDecorationsForChild(View child, Rect outRect) {
                        // There's only a single item decoration that cares about the
                        // itemOffsets, so
                        // we just call it manually so they are never cached. This way, it's
                        // updated as the
                        // tiles are moved around.
                        // It only sets the left and right margin and only cares about tiles (not
                        // TextView).
