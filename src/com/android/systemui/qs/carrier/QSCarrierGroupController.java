...
public class QSCarrierGroupController {
    ...
    private final View[] mCarrierDividers = new View[SIM_SLOTS - 1];
    private final QSCarrier[] mCarrierGroups = new QSCarrier[SIM_SLOTS];
    private final int[] mLastSignalLevel = new int[SIM_SLOTS];
    private final String[] mLastSignalLevelDescription = new String[SIM_SLOTS];
    ...
    private QSCarrierGroupController(QSCarrierGroup view, ActivityStarter activityStarter,
        ...
        mProviderModel = featureFlags.isEnabled(Flags.COMBINED_STATUS_BAR_SIGNAL_ICONS);
    ...
    private static class H extends Handler {
        ...
        private final Consumer<CarrierTextManager.CarrierTextCallbackInfo> mUpdateCarrierInfo;
        private final Runnable mUpdateState;
