...
public class DozeLog implements Dumpable {
    ...
    private final SummaryStats mPickupPulseNearVibrationStats;
    private final SummaryStats mPickupPulseNotNearVibrationStats;
    private final SummaryStats mNotificationPulseStats;
    private final SummaryStats mScreenOnPulsingStats;
    private final SummaryStats mScreenOnNotPulsingStats;
    private final SummaryStats mEmergencyCallStats;
    ...
    private final SummaryStats[][] mProxStats; // [reason][near/far]
    ...
    public static String reasonToString(@Reason int pulseReason) {
        switch (pulseReason) {
            case PULSE_REASON_INTENT:
                return "intent";
            case PULSE_REASON_NOTIFICATION:
                return "notification";
            ...
            case REASON_SENSOR_DOUBLE_TAP:
                return "doubletap";
            case PULSE_REASON_SENSOR_LONG_PRESS:
                return "longpress";
            case PULSE_REASON_DOCKING:
                return "docking";
            case PULSE_REASON_SENSOR_WAKE_REACH:
                return "reach-wakelockscreen";
            case REASON_SENSOR_WAKE_UP_PRESENCE:
                return "presence-wakeup";
            case REASON_SENSOR_TAP:
                return "tap";
            case REASON_SENSOR_UDFPS_LONG_PRESS:
                return "udfps";
            case REASON_SENSOR_QUICK_PICKUP:
                return "quickPickup";
            default:
                throw new IllegalArgumentException("invalid reason: " + pulseReason);
        }
    }
