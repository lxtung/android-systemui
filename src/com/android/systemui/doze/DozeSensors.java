...
public class DozeSensors {
    ...
    private final boolean mSelectivelyRegisterProxSensors;
    ...
    class TriggerSensor extends TriggerEventListener {
        @NonNull
        final Sensor[] mSensors; // index = posture, value = sensor
    ...
    class PluginSensor extends TriggerSensor implements SensorManagerPlugin.SensorEventListener {
        ...
        @Override
        public String toString() {
            return "{mRegistered=" + mRegistered +
                    ", mRequested=" + mRequested +
                    ", mDisabled=" + mDisabled +
                    ", mConfigured=" + mConfigured +
                    ", mIgnoresSetting=" + mIgnoresSetting +
                    ", mSensor=" + mPluginSensor + "}";
        }
