...
class PeopleStoryIconFactory implements AutoCloseable {
    ...
    private final int mImportantConversationColor;
    ...
    public static class PeopleStoryIconDrawable extends Drawable {
        private final float mFullIconSize;
        private final RoundedBitmapDrawable mAvatar;
        private final Drawable mBadgeIcon;
        private final int mIconSize;
        private final Paint mPriorityRingPaint;
        private final boolean mShowImportantRing;
        private final boolean mShowStoryRing;
        private final Paint mStoryPaint;
        private final float mDensity;
