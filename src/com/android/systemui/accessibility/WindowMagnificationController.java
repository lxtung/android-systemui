...
class WindowMagnificationController implements View.OnTouchListener, SurfaceHolder.Callback,
     ...
     *
     * @param scale                          The target scale, or {@link Float#NaN} to leave
     *                                       unchanged.
     * @param centerX                        The screen-relative X coordinate around which to
     *                                       center for magnification,
     ...
     * @param animationCallback              Called when the transition is complete, the given
     *                                       arguments
     *                                       are as same as current values, or the transition is
     *                                       interrupted
     *                                       due to the new transition request.
     */
