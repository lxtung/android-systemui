...
public class ScreenRecordingMuxer {
    ...
    private static final String TAG = "ScreenRecordingMuxer";
    private final String[] mFiles;
    private final String mOutFile;
    private final int mFormat;
    private final ArrayMap<Pair<MediaExtractor, Integer>, Integer> mExtractorIndexToMuxerIndex
            = new ArrayMap<>();
    private final ArrayList<MediaExtractor> mExtractors = new ArrayList<>();
