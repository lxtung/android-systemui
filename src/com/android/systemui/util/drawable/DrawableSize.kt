            ...
            traceSection("DrawableSize#downscaleToSize") {
                ...
                if (originalWidth < maxWidth && originalHeight < maxHeight) {
                    if (Log.isLoggable(TAG, Log.DEBUG)) {
                        Log.d(
                            TAG, "Not resizing $originalWidth x $originalHeight" + " " +
                ...
                if (width <= 0 || height <= 0) {
                    Log.w(
                        TAG, "Attempted to resize ${drawable.javaClass.simpleName} " +
                ...
                if (Log.isLoggable(TAG, Log.DEBUG)) {
                    Log.d(
                        TAG, "Resizing large drawable (${drawable.javaClass.simpleName}) " +
