...
class TransitionLayout @JvmOverloads constructor(
    ...
    private fun applyCurrentState() {
        ...
        for (i in 0 until childCount) {
            ...
            if (child.measuredWidth != widgetState.measureWidth ||
                ...
                val measureWidthSpec = MeasureSpec.makeMeasureSpec(
                    widgetState.measureWidth,
                    MeasureSpec.EXACTLY
                )
                val measureHeightSpec = MeasureSpec.makeMeasureSpec(
                    widgetState.measureHeight,
                    MeasureSpec.EXACTLY
                )
    ...
    private fun updateBounds() {
        ...
        setLeftTopRightBottom(
            layoutLeft, layoutTop, layoutLeft + currentState.width,
