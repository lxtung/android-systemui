    ...
    fun getInterpolatedState(
        ...
        for (i in 0 until childCount) {
            ...
            if (widgetStart.gone != widgetEnd.gone) {
                ...
                if (widgetStart.gone) {
                    ...
                    alphaProgress = MathUtils.map(
                        0.0f, 1.0f - GONE_FADE_FRACTION, 0.0f, 1.0f,
                        progress
                    )
            ...
            resultWidgetState.apply {
                ...
                width = MathUtils.lerp(
                    widgetStart.width.toFloat(), widgetEnd.width.toFloat(),
                    widthProgress
                ).toInt()
                height = MathUtils.lerp(
                    widgetStart.height.toFloat(), widgetEnd.height.toFloat(),
                    widthProgress
                ).toInt()
                scale = newScale
        ...
        resultState.apply {
            width = MathUtils.lerp(
                startState.width.toFloat(), endState.width.toFloat(),
                progress
            ).toInt()
            height = MathUtils.lerp(
                startState.height.toFloat(), endState.height.toFloat(),
                progress
            ).toInt()
            translation.x = MathUtils.lerp(
                startState.translation.x, endState.translation.x,
                progress
            )
            translation.y = MathUtils.lerp(
                startState.translation.y, endState.translation.y,
                progress
            )
