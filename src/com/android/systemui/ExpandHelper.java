...
public class ExpandHelper implements Gefingerpoken {
    ...
    private final float mPullGestureMinXSpan;
    private final Callback mCallback;
    private ScaleGestureDetector mSGD;
    private final ViewScaler mScaler;
    private final ObjectAnimator mScaleAnimation;
    private boolean mEnabled = true;
    private ExpandableView mResizedView;
    private float mCurrentHeight;
    private int mSmallSize;
    private final int mLargeSize;
    private final float mMaximumStretch;
    ...
    public ExpandHelper(Context context, Callback callback, int small, int large) {
        ...
        mSlopMultiplier = ViewConfiguration.getAmbiguousGestureMultiplier();
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mExpanding && 0 != (mExpansionStyle & BLINDS)) {
                    ...
                    mScaler.setHeight(newHeight);
                    mLastMotionY = ev.getRawY();
                    mCallback.expansionStateChanged(!isFinished);
                    return true;
                }
