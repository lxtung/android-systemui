            ...
            new IAppTransitionAnimationSpecsFuture.Stub() {
                ...
                public AppTransitionAnimationSpec[] get() throws RemoteException {
                    try {
                        ...
                        // Clear reference to the compose task this future holds onto the
                        // reference to it's
                        // implementation (which can leak references to the bitmap it creates for
                        // the
                        // transition)
                        mComposeTask = null;
                        if (specs == null) {
                        ...
                        AppTransitionAnimationSpec[] arr =
