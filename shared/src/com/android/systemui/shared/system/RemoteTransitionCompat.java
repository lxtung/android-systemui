...
public class RemoteTransitionCompat implements Parcelable {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/frameworks/base/packages/SystemUI/shared/src/com/android
    // /systemui/shared/system/RemoteTransitionCompat.java
    //
    ...
    protected RemoteTransitionCompat(@NonNull android.os.Parcel in) {
        ...
        TransitionFilter filter = (flg & 0x2) == 0 ? null :
                (TransitionFilter) in.readTypedObject(TransitionFilter.CREATOR);
    ...
    @DataClass.Generated(
            ...
            sourceFile = "frameworks/base/packages/SystemUI/shared/src/com/android/systemui" +
                    "/shared/system/RemoteTransitionCompat.java",
            inputSignatures = "private static final  java.lang.String TAG\nfinal @android" +
                    ".annotation.NonNull android.window.RemoteTransition mTransition\n @android" +
                    ".annotation.Nullable android.window.TransitionFilter mFilter\npublic  void " +
                    "addHomeOpenCheck(android.content.ComponentName)\nclass " +
                    "RemoteTransitionCompat extends java.lang.Object implements [android.os" +
                    ".Parcelable]\nprivate  com.android.systemui.shared.system" +
                    ".RecentsAnimationControllerCompat mWrapped\nprivate  android.window" +
                    ".IRemoteTransitionFinishedCallback mFinishCB\nprivate  android.window" +
                    ".WindowContainerToken mPausingTask\nprivate  android.window" +
                    ".WindowContainerToken mPipTask\nprivate  android.window.TransitionInfo " +
                    "mInfo\nprivate  android.view.SurfaceControl mOpeningLeash\nprivate  android" +
                    ".util.ArrayMap<android.view.SurfaceControl,android.view.SurfaceControl> " +
                    "mLeashMap\nprivate  android.window.PictureInPictureSurfaceTransaction " +
                    "mPipTransaction\nprivate  android.os.IBinder mTransition\n  void setup(com" +
                    ".android.systemui.shared.system.RecentsAnimationControllerCompat,android" +
                    ".window.TransitionInfo,android.window.IRemoteTransitionFinishedCallback," +
                    "android.window.WindowContainerToken,android.window.WindowContainerToken," +
                    "android.util.ArrayMap<android.view.SurfaceControl,android.view" +
                    ".SurfaceControl>,android.os.IBinder)\n @android.annotation.SuppressLint " +
                    "boolean merge(android.window.TransitionInfo,android.view.SurfaceControl" +
                    ".Transaction,com.android.systemui.shared.system.RecentsAnimationListener)" +
                    "\npublic @java.lang.Override com.android.systemui.shared.recents.model" +
                    ".ThumbnailData screenshotTask(int)\npublic @java.lang.Override void " +
                    "setInputConsumerEnabled(boolean)\npublic @java.lang.Override void " +
                    "setAnimationTargetsBehindSystemBars(boolean)\npublic @java.lang.Override " +
                    "void hideCurrentInputMethod()\npublic @java.lang.Override void " +
                    "setFinishTaskTransaction(int,android.window" +
                    ".PictureInPictureSurfaceTransaction,android.view.SurfaceControl)\npublic " +
                    "@java.lang.Override @android.annotation.SuppressLint void finish(boolean," +
                    "boolean)\npublic @java.lang.Override void setDeferCancelUntilNextTransition" +
                    "(boolean,boolean)\npublic @java.lang.Override void cleanupScreenshot()" +
                    "\npublic @java.lang.Override void setWillFinishToHome(boolean)\npublic @java" +
                    ".lang.Override boolean removeTask(int)\npublic @java.lang.Override void " +
                    "detachNavigationBarFromApp(boolean)\npublic @java.lang.Override void " +
                    "animateNavigationBarToApp(long)\nclass RecentsControllerWrap extends com" +
                    ".android.systemui.shared.system.RecentsAnimationControllerCompat implements " +
    ...
    static class RecentsControllerWrap extends RecentsAnimationControllerCompat {
        ...
        void setup(RecentsAnimationControllerCompat wrapped, TransitionInfo info,
                   ...
                   WindowContainerToken recentsTask,
        ...
        public boolean removeTask(int taskId) {
            return mWrapped != null && mWrapped.removeTask(taskId);
        }
